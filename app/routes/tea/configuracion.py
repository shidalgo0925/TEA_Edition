...
def configuracion_principal():
    ...
    return render_template('tea/configuracion_principal.html', config=config)

@configuracion_bp.route('/colores')
@login_required
def configuracion_colores():
    ...
    return render_template('tea/configuracion_colores.html', config=config)

@configuracion_bp.route('/dificultad')
@login_required
def configuracion_dificultad():
    ...
    return render_template('tea/configuracion_dificultad.html', config=config)

@configuracion_bp.route('/interfaz')
@login_required
def configuracion_interfaz():
    ...
    return render_template('tea/configuracion_interfaz.html', config=config)

@configuracion_bp.route('/avatar')
@login_required
def configuracion_avatar():
    ...
    return render_template('tea/configuracion_avatar.html', config=config)

@configuracion_bp.route('/accesibilidad')
@login_required
def configuracion_accesibilidad():
    ...
    return render_template('tea/configuracion_accesibilidad.html', config=config)
